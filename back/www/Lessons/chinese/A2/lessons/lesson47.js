...
// ===== سوالات درس ۴۷ - چینی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "词典" است؟',
    speak: '词典',
    options: [
      { text: '百科全书', image: '../../../media/a2/school/encyclopedia.png' },
      { text: '词典', image: '../../../media/a2/school/dictionary.png' },
      { text: '地图册', image: '../../../media/a2/school/atlas.png' },
      { text: '指南针', image: '../../../media/a2/school/compass.png' }
    ],
    answer: '词典'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "百科全书" است؟',
    speak: '百科全书',
    options: [
      { text: '词典', image: '../../../media/a2/school/dictionary.png' },
      { text: '百科全书', image: '../../../media/a2/school/encyclopedia.png' },
      { text: '量角器', image: '../../../media/a2/school/protractor.png' },
      { text: '地图册', image: '../../../media/a2/school/atlas.png' }
    ],
    answer: '百科全书'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "地图册" است؟',
    speak: '地图册',
    options: [
      { text: '指南针', image: '../../../media/a2/school/compass.png' },
      { text: '词典', image: '../../../media/a2/school/dictionary.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "量角器" است؟',
    speak: '量角器',
    options: [
      { text: '地图册', image: '../../../media/a2/school/atlas.png' },
      { text: '量角器', image: '../../../media/a2/school/protractor.png' },
