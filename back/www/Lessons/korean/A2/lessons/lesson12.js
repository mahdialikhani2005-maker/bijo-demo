...
const questions = [
  ...
  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    ...
    speak: '호텔',
    options: [
      { text: '호텔', image: '../../../media/a2/city/hotel.png' },
      { text: '카페', image: '../../../media/a2/city/cafe.png' },
      { text: '빵집', image: '../../../media/a2/city/bakery.png' },
      { text: '약국', image: '../../../media/a2/city/pharmacy.png' }
    ],
    answer: '호텔'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "카페" است؟',
    speak: '카페',
    options: [
      { text: '정육점', image: '../../../media/a2/city/butchery.png' },
      { text: '카페', image: '../../../media/a2/city/cafe.png' },
      { text: '호텔', image: '../../../media/a2/city/hotel.png' },
      { text: '빵집', image: '../../../media/a2/city/bakery.png' }
    ],
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "빵집" است؟',
    speak: '빵집',
    options: [
      { text: '호텔', image: '../../../media/a2/city/hotel.png' },
      { text: '빵집', image: '../../../media/a2/city/bakery.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "약국" است؟',
    speak: '약국',
    options: [
      { text: '카페', image: '../../../media/a2/city/cafe.png' },
      { text: '호텔', image: '../../../media/a2/city/hotel.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "정육점" است؟',
    speak: '정육점',
    options: [
      { text: '정육점', image: '../../../media/a2/city/butchery.png' },
      { text: '약국', image: '../../../media/a2/city/pharmacy.png' },
