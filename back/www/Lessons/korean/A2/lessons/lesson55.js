...
// ===== سوالات درس ۵۵ - کره‌ای به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "비자" است؟',
    speak: '비자',
    options: [
      { text: '비자', image: '../../../media/a2/travel/visa.png' },
      { text: '통화', image: '../../../media/a2/travel/currency.png' },
      { text: '환전', image: '../../../media/a2/travel/exchange.png' },
      { text: '출발', image: '../../../media/a2/travel/departure.png' }
    ],
    answer: '비자'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "통화" است؟',
    speak: '통화',
    options: [
      { text: '도착', image: '../../../media/a2/travel/arrival.png' },
      { text: '통화', image: '../../../media/a2/travel/currency.png' },
      { text: '비자', image: '../../../media/a2/travel/visa.png' },
      { text: '환전', image: '../../../media/a2/travel/exchange.png' }
    ],
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "환전" است؟',
    speak: '환전',
    options: [
      { text: '비자', image: '../../../media/a2/travel/visa.png' },
      { text: '환전', image: '../../../media/a2/travel/exchange.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "출발" است؟',
    speak: '출발',
    options: [
      { text: '통화', image: '../../../media/a2/travel/currency.png' },
      { text: '비자', image: '../../../media/a2/travel/visa.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "도착" است؟',
    speak: '도착',
    options: [
      { text: '도착', image: '../../../media/a2/travel/arrival.png' },
      { text: '출발', image: '../../../media/a2/travel/departure.png' },
