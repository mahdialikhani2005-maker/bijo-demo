...
// ===== سوالات درس ۳۷ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "شلال"؟',
    speak: 'شلال',
    options: [
      { text: 'بركان', image: '../../../media/a2/nature/volcano.png' },
      { text: 'شلال', image: '../../../media/a2/nature/waterfall.png' },
      { text: 'نهر جليدي', image: '../../../media/a2/nature/glacier.png' },
      { text: 'وادٍ', image: '../../../media/a2/nature/canyon.png' }
    ],
    answer: 'شلال'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "بركان"؟',
    speak: 'بركان',
    options: [
      { text: 'شلال', image: '../../../media/a2/nature/waterfall.png' },
      { text: 'بركان', image: '../../../media/a2/nature/volcano.png' },
      { text: 'كهف', image: '../../../media/a2/nature/cave.png' },
      { text: 'نهر جليدي', image: '../../../media/a2/nature/glacier.png' }
    ],
    answer: 'بركان'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['بركان', 'شلال', 'نهر جليدي', 'وادٍ'],
    answer: 'شلال'
  },
  {
    type: 'word',
    ...
    options: ['شلال', 'بركان', 'كهف', 'نهر جليدي'],
    answer: 'بركان'
  },
  {
    type: 'word',
    ...
    options: ['وادٍ', 'شلال', 'نهر جليدي', 'بركان'],
    answer: 'نهر جليدي'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['نهر جليدي', 'كهف', 'وادٍ', 'بركان'],
    answer: 'كهف'
  },
  ...
  },
  {
    ...
    speak: 'هذا نهر جليدي',
    question: 'كون الجملة العربية:',
    text: 'این یخچال طبیعی است',
    words: ['جليدي', 'نهر', 'هذا'],
    answer: ['هذا', 'نهر', 'جليدي']
  },
  {
    type: 'build-en',
    speak: 'هذا وادٍ',
  ...
  },
  {
    ...
    question: 'ترجمه را بساز:',
    text: 'هذا بركان',
    words: ['است', 'آتشفشان', 'این'],
    answer: ['این', 'آتشفشان', 'است']
  },
  {
    type: 'build-fa',
    speak: 'هذا نهر جليدي',
    question: 'ترجمه را بساز:',
    text: 'هذا نهر جليدي',
    words: ['است', 'یخچال طبیعی', 'این'],
    answer: ['این', 'یخچال طبیعی', 'است']
  },
  {
    type: 'build-fa',
    speak: 'هذا وادٍ',
