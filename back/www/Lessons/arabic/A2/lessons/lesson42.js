...
// ===== سوالات درس ۴۲ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "دماغ"؟',
    speak: 'دماغ',
    options: [
      { text: 'عصب', image: '../../../media/a2/health/nerve.png' },
      { text: 'دماغ', image: '../../../media/a2/health/brain.png' },
      { text: 'وريد', image: '../../../media/a2/health/vein.png' },
      { text: 'شريان', image: '../../../media/a2/health/artery.png' }
    ],
    answer: 'دماغ'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "عصب"؟',
    speak: 'عصب',
    options: [
      { text: 'دماغ', image: '../../../media/a2/health/brain.png' },
      { text: 'عصب', image: '../../../media/a2/health/nerve.png' },
      { text: 'مفصل', image: '../../../media/a2/health/joint.png' },
      { text: 'وريد', image: '../../../media/a2/health/vein.png' }
    ],
    answer: 'عصب'
  },
