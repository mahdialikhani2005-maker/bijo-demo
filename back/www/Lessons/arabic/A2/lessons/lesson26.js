...
// ===== سوالات درس ۲۶ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "حزام"؟',
    speak: 'حزام',
    options: [
      { text: 'وشاح', image: '../../../media/a2/clothes/scarf.png' },
      { text: 'حزام', image: '../../../media/a2/clothes/belt.png' },
      { text: 'قفازات', image: '../../../media/a2/clothes/gloves.png' },
      { text: 'ساعة يد', image: '../../../media/a2/clothes/watch.png' }
    ],
    answer: 'حزام'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "وشاح"؟',
    speak: 'وشاح',
    options: [
      { text: 'حزام', image: '../../../media/a2/clothes/belt.png' },
      { text: 'وشاح', image: '../../../media/a2/clothes/scarf.png' },
      { text: 'قلادة', image: '../../../media/a2/clothes/necklace.png' },
      { text: 'قفازات', image: '../../../media/a2/clothes/gloves.png' }
    ],
    answer: 'وشاح'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['وشاح', 'حزام', 'قفازات', 'ساعة يد'],
    answer: 'حزام'
  },
  {
    type: 'word',
    ...
    options: ['حزام', 'وشاح', 'قلادة', 'قفازات'],
    answer: 'وشاح'
  },
  {
    type: 'word',
    ...
    options: ['ساعة يد', 'حزام', 'قفازات', 'وشاح'],
    answer: 'قفازات'
  },
  {
    type: 'word',
    ...
    options: ['ساعة يد', 'قلادة', 'وشاح', 'حزام'],
    answer: 'ساعة يد'
  },
  {
    type: 'word',
    ...
    options: ['قفازات', 'قلادة', 'ساعة يد', 'وشاح'],
    answer: 'قلادة'
  },
