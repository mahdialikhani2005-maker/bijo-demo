...
// ===== سوالات درس ۲۲ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "بيتزا"؟',
    speak: 'بيتزا',
    options: [
      { text: 'باستا', image: '../../../media/a2/food/pasta.png' },
      { text: 'بيتزا', image: '../../../media/a2/food/pizza.png' },
      { text: 'سلطة', image: '../../../media/a2/food/salad.png' },
      { text: 'ساندويتش', image: '../../../media/a2/food/sandwich.png' }
    ],
    answer: 'بيتزا'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "باستا"؟',
    speak: 'باستا',
    options: [
      { text: 'بيتزا', image: '../../../media/a2/food/pizza.png' },
      { text: 'باستا', image: '../../../media/a2/food/pasta.png' },
      { text: 'برغر', image: '../../../media/a2/food/burger.png' },
      { text: 'سلطة', image: '../../../media/a2/food/salad.png' }
    ],
    answer: 'باستا'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['باستا', 'بيتزا', 'سلطة', 'ساندويتش'],
    answer: 'بيتزا'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['ساندويتش', 'بيتزا', 'سلطة', 'باستا'],
    answer: 'سلطة'
  },
  {
    type: 'word',
    ...
    options: ['ساندويتش', 'برغر', 'باستا', 'بيتزا'],
    answer: 'ساندويتش'
  },
  {
    type: 'word',
    ...
    options: ['سلطة', 'برغر', 'ساندويتش', 'باستا'],
    answer: 'برغر'
  },
