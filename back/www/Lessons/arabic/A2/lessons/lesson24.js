...
// ===== سوالات درس ۲۴ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "زبدة"؟',
    speak: 'زبدة',
    options: [
      { text: 'جبن', image: '../../../media/a2/food/cheese.png' },
      { text: 'زبدة', image: '../../../media/a2/food/butter.png' },
      { text: 'قشدة', image: '../../../media/a2/food/cream.png' },
      { text: 'زبادي', image: '../../../media/a2/food/yogurt.png' }
    ],
    answer: 'زبدة'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "جبن"؟',
    speak: 'جبن',
    options: [
      { text: 'زبدة', image: '../../../media/a2/food/butter.png' },
      { text: 'جبن', image: '../../../media/a2/food/cheese.png' },
      { text: 'آيس كريم', image: '../../../media/a2/food/icecream.png' },
      { text: 'قشدة', image: '../../../media/a2/food/cream.png' }
    ],
    answer: 'جبن'
  },
  ...
  },
  {
    ...
    options: ['زبدة', 'جبن', 'آيس كريم', 'قشدة'],
    answer: 'جبن'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['زبادي', 'آيس كريم', 'جبن', 'زبدة'],
    answer: 'زبادي'
  },
  {
    type: 'word',
    ...
    options: ['قشدة', 'آيس كريم', 'زبادي', 'جبن'],
    answer: 'آيس كريم'
  },
