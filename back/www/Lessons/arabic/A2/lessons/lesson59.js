...
// ===== سوالات درس ۵۹ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "تحميل"؟',
    speak: 'تحميل',
    options: [
      { text: 'رفع', image: '../../../media/a2/technology/upload.png' },
      { text: 'تحميل', image: '../../../media/a2/technology/download.png' },
      { text: 'بث مباشر', image: '../../../media/a2/technology/stream.png' },
      { text: 'فيديو', image: '../../../media/a2/technology/video.png' }
    ],
    answer: 'تحميل'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "رفع"؟',
    speak: 'رفع',
    options: [
      { text: 'تحميل', image: '../../../media/a2/technology/download.png' },
      { text: 'رفع', image: '../../../media/a2/technology/upload.png' },
      { text: 'صوت', image: '../../../media/a2/technology/audio.png' },
      { text: 'بث مباشر', image: '../../../media/a2/technology/stream.png' }
    ],
    answer: 'رفع'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['رفع', 'تحميل', 'بث مباشر', 'فيديو'],
    answer: 'تحميل'
  },
  {
    type: 'word',
    ...
    options: ['تحميل', 'رفع', 'صوت', 'بث مباشر'],
    answer: 'رفع'
  },
  {
    type: 'word',
    ...
    options: ['فيديو', 'تحميل', 'بث مباشر', 'رفع'],
    answer: 'بث مباشر'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['بث مباشر', 'صوت', 'فيديو', 'رفع'],
    answer: 'صوت'
  },
