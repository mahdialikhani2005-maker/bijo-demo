...
// ===== سوالات درس ۳۰ - چینی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "雨伞" است؟',
    speak: '雨伞',
    options: [
      { text: '包', image: '../../../media/a2/clothes/bag.png' },
      { text: '雨伞', image: '../../../media/a2/clothes/umbrella.png' },
      { text: '背包', image: '../../../media/a2/clothes/backpack.png' },
      { text: '钱包', image: '../../../media/a2/clothes/wallet.png' }
    ],
    answer: '雨伞'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "包" است؟',
    speak: '包',
    options: [
      { text: '雨伞', image: '../../../media/a2/clothes/umbrella.png' },
      { text: '包', image: '../../../media/a2/clothes/bag.png' },
      { text: '手提包', image: '../../../media/a2/clothes/purse.png' },
      { text: '背包', image: '../../../media/a2/clothes/backpack.png' }
    ],
    answer: '包'
  },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "钱包" است؟',
    speak: '钱包',
    options: [
      { text: '钱包', image: '../../../media/a2/clothes/wallet.png' },
      { text: '手提包', image: '../../../media/a2/clothes/purse.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "手提包" است؟',
    speak: '手提包',
    options: [
      { text: '背包', image: '../../../media/a2/clothes/backpack.png' },
      { text: '手提包', image: '../../../media/a2/clothes/purse.png' },
