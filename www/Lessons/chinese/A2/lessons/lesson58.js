...
// ===== سوالات درس ۵۸ - چینی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "软件" است؟',
    speak: '软件',
    options: [
      { text: '硬件', image: '../../../media/a2/technology/hardware.png' },
      { text: '软件', image: '../../../media/a2/technology/software.png' },
      { text: '更新', image: '../../../media/a2/technology/update.png' },
      { text: '密码', image: '../../../media/a2/technology/password.png' }
    ],
    answer: '软件'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "硬件" است؟',
    speak: '硬件',
    options: [
      { text: '软件', image: '../../../media/a2/technology/software.png' },
      { text: '硬件', image: '../../../media/a2/technology/hardware.png' },
      { text: '账户', image: '../../../media/a2/technology/account.png' },
      { text: '更新', image: '../../../media/a2/technology/update.png' }
    ],
    answer: '硬件'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "更新" است؟',
    speak: '更新',
    options: [
      { text: '密码', image: '../../../media/a2/technology/password.png' },
      { text: '软件', image: '../../../media/a2/technology/software.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "密码" است؟',
    speak: '密码',
    options: [
      { text: '密码', image: '../../../media/a2/technology/password.png' },
      { text: '账户', image: '../../../media/a2/technology/account.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "账户" است؟',
    speak: '账户',
    options: [
      { text: '更新', image: '../../../media/a2/technology/update.png' },
      { text: '账户', image: '../../../media/a2/technology/account.png' },
