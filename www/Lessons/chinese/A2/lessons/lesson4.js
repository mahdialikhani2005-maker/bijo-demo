...
// ===== سوالات درس ۴ - چینی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "新郎" است؟',
    speak: '新郎',
    options: [
      { text: '姻亲', image: '../../../media/a2/family/inlaw.png' },
      { text: '新郎', image: '../../../media/a2/family/groom.png' },
      { text: '继父', image: '../../../media/a2/family/stepfather.png' },
      { text: '继母', image: '../../../media/a2/family/stepmother.png' }
    ],
    answer: '新郎'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "姻亲" است؟',
    speak: '姻亲',
    options: [
      { text: '新郎', image: '../../../media/a2/family/groom.png' },
      { text: '姻亲', image: '../../../media/a2/family/inlaw.png' },
      { text: '异父/异母姐妹', image: '../../../media/a2/family/stepsister.png' },
      { text: '继父', image: '../../../media/a2/family/stepfather.png' }
    ],
    answer: '姻亲'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "继父" است؟',
    speak: '继父',
    options: [
      { text: '继母', image: '../../../media/a2/family/stepmother.png' },
      { text: '新郎', image: '../../../media/a2/family/groom.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "继母" است؟',
    speak: '继母',
    options: [
      { text: '继母', image: '../../../media/a2/family/stepmother.png' },
      { text: '异父/异母姐妹', image: '../../../media/a2/family/stepsister.png' },
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "异父/异母姐妹" است؟',
    speak: '异父/异母姐妹',
    options: [
      { text: '继父', image: '../../../media/a2/family/stepfather.png' },
      { text: '异父/异母姐妹', image: '../../../media/a2/family/stepsister.png' },
  ...
  },
  {
    ...
    words: ['异父/异母姐妹', '我的', '她', '是'],
    answer: ['她', '是', '我的', '异父/异母姐妹']
  },
