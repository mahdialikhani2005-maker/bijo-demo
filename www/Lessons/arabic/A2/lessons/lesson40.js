...
// ===== سوالات درس ۴۰ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "قوس قزح"؟',
    speak: 'قوس قزح',
    options: [
      { text: 'نسيم', image: '../../../media/a2/nature/breeze.png' },
      { text: 'قوس قزح', image: '../../../media/a2/nature/rainbow.png' },
      { text: 'فيضان', image: '../../../media/a2/nature/flood.png' },
      { text: 'جفاف', image: '../../../media/a2/nature/drought.png' }
    ],
    answer: 'قوس قزح'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "نسيم"؟',
    speak: 'نسيم',
    options: [
      { text: 'قوس قزح', image: '../../../media/a2/nature/rainbow.png' },
      { text: 'نسيم', image: '../../../media/a2/nature/breeze.png' },
      { text: 'زلزال', image: '../../../media/a2/nature/earthquake.png' },
      { text: 'فيضان', image: '../../../media/a2/nature/flood.png' }
    ],
    answer: 'نسيم'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['نسيم', 'قوس قزح', 'فيضان', 'جفاف'],
    answer: 'قوس قزح'
  },
  {
    type: 'word',
    ...
    options: ['قوس قزح', 'نسيم', 'زلزال', 'فيضان'],
    answer: 'نسيم'
  },
  {
    type: 'word',
    ...
    options: ['جفاف', 'قوس قزح', 'فيضان', 'نسيم'],
    answer: 'فيضان'
  },
  {
    type: 'word',
    ...
    options: ['جفاف', 'زلزال', 'نسيم', 'قوس قزح'],
    answer: 'جفاف'
  },
  {
    type: 'word',
