...
// ===== سوالات درس ۹ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "غلاية"؟',
    speak: 'غلاية',
    options: [
      { text: 'محمصة', image: '../../../media/a2/house/toaster.png' },
      { text: 'غلاية', image: '../../../media/a2/house/kettle.png' },
      { text: 'خلاط', image: '../../../media/a2/house/blender.png' },
      { text: 'ميكروويف', image: '../../../media/a2/house/microwave.png' }
    ],
    answer: 'غلاية'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "محمصة"؟',
    speak: 'محمصة',
    options: [
      { text: 'غلاية', image: '../../../media/a2/house/kettle.png' },
      { text: 'محمصة', image: '../../../media/a2/house/toaster.png' },
      { text: 'غسالة صحون', image: '../../../media/a2/house/dishwasher.png' },
      { text: 'خلاط', image: '../../../media/a2/house/blender.png' }
    ],
    answer: 'محمصة'
  },
  ...
  {
    type: 'image',
    question: 'أي صورة لـ "غسالة صحون"؟',
    speak: 'غسالة صحون',
    options: [
      { text: 'خلاط', image: '../../../media/a2/house/blender.png' },
      { text: 'غسالة صحون', image: '../../../media/a2/house/dishwasher.png' },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['محمصة', 'غلاية', 'خلاط', 'ميكروويف'],
    answer: 'غلاية'
  },
  {
    type: 'word',
    ...
    options: ['غلاية', 'محمصة', 'غسالة صحون', 'خلاط'],
    answer: 'محمصة'
  },
  {
    type: 'word',
    ...
    options: ['ميكروويف', 'غلاية', 'خلاط', 'محمصة'],
    answer: 'خلاط'
  },
  {
    type: 'word',
    ...
    options: ['ميكروويف', 'غسالة صحون', 'محمصة', 'غلاية'],
    answer: 'ميكروويف'
  },
  {
    type: 'word',
    ...
    options: ['خلاط', 'غسالة صحون', 'ميكروويف', 'محمصة'],
    answer: 'غسالة صحون'
  },
  ...
  {
    type: 'build-en',
    speak: 'هذه غسالة صحون',
    question: 'كون الجملة العربية:',
    text: 'این ماشین ظرفشویی است',
    words: ['صحون', 'غسالة', 'هذه'],
    answer: ['هذه', 'غسالة', 'صحون']
  },
