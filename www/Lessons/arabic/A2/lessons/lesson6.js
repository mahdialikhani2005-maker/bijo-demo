...
// ===== سوالات درس ۶ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "أريكة"؟',
    speak: 'أريكة',
    options: [
      { text: 'ثلاجة', image: '../../../media/a2/house/fridge.png' },
      { text: 'أريكة', image: '../../../media/a2/house/sofa.png' },
      { text: 'خزانة ملابس', image: '../../../media/a2/house/wardrobe.png' },
      { text: 'مرآة', image: '../../../media/a2/house/mirror.png' }
    ],
    answer: 'أريكة'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "ثلاجة"؟',
    speak: 'ثلاجة',
    options: [
      { text: 'أريكة', image: '../../../media/a2/house/sofa.png' },
      { text: 'ثلاجة', image: '../../../media/a2/house/fridge.png' },
      { text: 'رف', image: '../../../media/a2/house/shelf.png' },
      { text: 'خزانة ملابس', image: '../../../media/a2/house/wardrobe.png' }
    ],
    answer: 'ثلاجة'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "خزانة ملابس"؟',
    speak: 'خزانة ملابس',
    options: [
      { text: 'مرآة', image: '../../../media/a2/house/mirror.png' },
      { text: 'أريكة', image: '../../../media/a2/house/sofa.png' },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['ثلاجة', 'أريكة', 'خزانة ملابس', 'مرآة'],
    answer: 'أريكة'
  },
  {
    type: 'word',
    ...
    options: ['أريكة', 'ثلاجة', 'رف', 'خزانة ملابس'],
    answer: 'ثلاجة'
  },
  {
    type: 'word',
    ...
    options: ['مرآة', 'أريكة', 'خزانة ملابس', 'ثلاجة'],
    answer: 'خزانة ملابس'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['خزانة ملابس', 'رف', 'مرآة', 'ثلاجة'],
    answer: 'رف'
  },
  ...
  {
    type: 'build-en',
    speak: 'هذه خزانة ملابس',
    question: 'كون الجملة العربية:',
    text: 'این کمد لباس است',
    words: ['ملابس', 'خزانة', 'هذه'],
    answer: ['هذه', 'خزانة', 'ملابس']
  },
  {
    type: 'build-en',
    speak: 'هذه مرآة',
