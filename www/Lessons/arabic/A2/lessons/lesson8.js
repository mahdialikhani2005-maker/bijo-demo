...
// ===== سوالات درس ۸ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "شرفة"؟',
    speak: 'شرفة',
    options: [
      { text: 'جراج', image: '../../../media/a2/house/garage.png' },
      { text: 'شرفة', image: '../../../media/a2/house/balcony.png' },
      { text: 'قبو', image: '../../../media/a2/house/basement.png' },
      { text: 'علية', image: '../../../media/a2/house/attic.png' }
    ],
    answer: 'شرفة'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "جراج"؟',
    speak: 'جراج',
    options: [
      { text: 'شرفة', image: '../../../media/a2/house/balcony.png' },
      { text: 'جراج', image: '../../../media/a2/house/garage.png' },
      { text: 'فناء', image: '../../../media/a2/house/yard.png' },
      { text: 'قبو', image: '../../../media/a2/house/basement.png' }
    ],
    answer: 'جراج'
  },
