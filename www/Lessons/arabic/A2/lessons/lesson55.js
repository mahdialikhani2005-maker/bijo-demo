...
// ===== سوالات درس ۵۵ - عربی به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'أي صورة لـ "تأشيرة"؟',
    speak: 'تأشيرة',
    options: [
      { text: 'عملة', image: '../../../media/a2/travel/currency.png' },
      { text: 'تأشيرة', image: '../../../media/a2/travel/visa.png' },
      { text: 'تبادل', image: '../../../media/a2/travel/exchange.png' },
      { text: 'مغادرة', image: '../../../media/a2/travel/departure.png' }
    ],
    answer: 'تأشيرة'
  },
  {
    type: 'image',
    question: 'أي صورة لـ "عملة"؟',
    speak: 'عملة',
    options: [
      { text: 'تأشيرة', image: '../../../media/a2/travel/visa.png' },
      { text: 'عملة', image: '../../../media/a2/travel/currency.png' },
      { text: 'وصول', image: '../../../media/a2/travel/arrival.png' },
      { text: 'تبادل', image: '../../../media/a2/travel/exchange.png' }
    ],
    answer: 'عملة'
  },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['عملة', 'تأشيرة', 'تبادل', 'مغادرة'],
    answer: 'تأشيرة'
  },
  {
    type: 'word',
    ...
    options: ['تأشيرة', 'عملة', 'وصول', 'تبادل'],
    answer: 'عملة'
  },
  {
    type: 'word',
    ...
    options: ['مغادرة', 'تأشيرة', 'تبادل', 'عملة'],
    answer: 'تبادل'
  },
  {
    type: 'word',
    ...
    options: ['مغادرة', 'وصول', 'عملة', 'تأشيرة'],
    answer: 'مغادرة'
  },
  {
    type: 'word',
    ...
    options: ['تبادل', 'وصول', 'مغادرة', 'عملة'],
    answer: 'وصول'
  },
  ...
  },
  {
    ...
    question: 'ترجمه را بساز:',
    text: 'هذه عملة',
    words: ['است', 'واحد پول', 'این'],
    answer: ['این', 'واحد پول', 'است']
  },
  {
    type: 'build-fa',
    speak: 'هذا تبادل',
