...
// ===== سوالات درس ۴۷ - کره‌ای به فارسی =====
const questions = [

  // ===== بخش ۱: IMAGE (۵ تا) =====
  {
    type: 'image',
    question: 'کدام تصویر برای "사전" است؟',
    speak: '사전',
    options: [
      { text: '사전', image: '../../../media/a2/school/dictionary.png' },
      { text: '백과사전', image: '../../../media/a2/school/encyclopedia.png' },
      { text: '지도', image: '../../../media/a2/school/atlas.png' },
      { text: '나침반', image: '../../../media/a2/school/compass.png' }
    ],
    answer: '사전'
  },
  {
    type: 'image',
    question: 'کدام تصویر برای "백과사전" است؟',
    speak: '백과사전',
    options: [
      { text: '각도기', image: '../../../media/a2/school/protractor.png' },
      { text: '백과사전', image: '../../../media/a2/school/encyclopedia.png' },
      { text: '사전', image: '../../../media/a2/school/dictionary.png' },
      { text: '지도', image: '../../../media/a2/school/atlas.png' }
    ],
  ...
  {
    type: 'image',
    question: 'کدام تصویر برای "각도기" است؟',
    speak: '각도기',
    options: [
      { text: '각도기', image: '../../../media/a2/school/protractor.png' },
      { text: '나침반', image: '../../../media/a2/school/compass.png' },
