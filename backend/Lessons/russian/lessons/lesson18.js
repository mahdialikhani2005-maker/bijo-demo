...
{
type:"image",
question:"Есть کدام است؟",
speak:"есть",
options:[
{text:"спать",image:"../../media/actions/sleep.webp"},
{text:"есть",image:"../../media/actions/eat.webp"},
{text:"идти",image:"../../media/actions/walk.webp"},
{text:"читать",image:"../../media/actions/read.webp"}
],
answer:"есть"
},
...
{
type:"image",
question:"Спать کدام است؟",
speak:"спать",
options:[
{text:"писать",image:"../../media/actions/write.webp"},
{text:"спать",image:"../../media/actions/sleep.webp"},
{text:"есть",image:"../../media/actions/eat.webp"},
{text:"идти",image:"../../media/actions/walk.webp"}
],
...
options:["спать","есть","идти","читать"],
answer:"есть"
},
...
options:["писать","спать","есть","идти"],
answer:"спать"
},
...
options:["есть","идти","писать","спать"],
answer:"идти"
},
...
options:["идти","спать","читать","есть"],
answer:"читать"
},
...
options:["читать","есть","спать","писать"],
answer:"писать"
},
...
{
type:"build-ru",
speak:"Она спит ночью",
question:"جمله روسی را بساز:",
text:"او شب می‌خوابد",
words:["Она","спит","ночью"],
answer:["Она","спит","ночью"]
},

{
type:"build-ru",
speak:"Он идёт в школу",
question:"جمله روسی را بساز:",
text:"او به مدرسه راه می‌رود",
words:["Он","идёт","в","школу"],
answer:["Он","идёт","в","школу"]
},
